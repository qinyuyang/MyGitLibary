...
/*      */ 
/*      */ @Platform(value={"linux", "macosx"}, include={"<poll.h>", "<dc1394/dc1394.h>"}, link={"dc1394@.22"})
/*      */ public class dc1394
/*      */ {
...
/*      */     {
/* 1010 */       allocate(); } 
/* 1011 */     public dc1394format7modeset_t(int size) { allocateArray(size); } 
/* 1012 */     public dc1394format7modeset_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/* 1017 */     public dc1394format7modeset_t position(int position) { return (dc1394format7modeset_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     @MemberGetter
...
/*      */     {
/*  965 */       allocate(); } 
/*  966 */     public dc1394format7mode_t(int size) { allocateArray(size); } 
/*  967 */     public dc1394format7mode_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  972 */     public dc1394format7mode_t position(int position) { return (dc1394format7mode_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     @Cast({"dc1394bool_t"})
...
/*      */ 
/*      */     public native dc1394format7mode_t color_codings(dc1394.dc1394color_codings_t paramdc1394color_codings_t);
/*      */ 
...
/*      */     {
/*  821 */       allocate(); } 
/*  822 */     public dc1394video_frame_t(int size) { allocateArray(size); } 
/*  823 */     public dc1394video_frame_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  828 */     public dc1394video_frame_t position(int position) { return (dc1394video_frame_t)super.position(position); } 
/*      */     @Cast({"unsigned char*"})
...
/*      */ 
/*      */     public native dc1394.dc1394camera_t camera();
/*      */ 
/*      */     public native dc1394video_frame_t camera(dc1394.dc1394camera_t paramdc1394camera_t);
/*      */ 
...
/*      */ 
/*  860 */     public ByteBuffer getByteBuffer() { return image().capacity((int)total_bytes()).asByteBuffer(); }
/*      */ 
/*      */ 
/*      */     static
/*      */     {
...
/*      */     {
/*  804 */       allocate(); } 
/*  805 */     public dc1394framerates_t(int size) { allocateArray(size); } 
/*  806 */     public dc1394framerates_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  811 */     public dc1394framerates_t position(int position) { return (dc1394framerates_t)super.position(position); }
/*      */ 
/*      */ 
...
/*      */     {
/*  632 */       allocate(); } 
/*  633 */     public dc1394featureset_t(int size) { allocateArray(size); } 
/*  634 */     public dc1394featureset_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  639 */     public dc1394featureset_t position(int position) { return (dc1394featureset_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     @MemberGetter
...
/*      */     {
/*  575 */       allocate(); } 
/*  576 */     public dc1394feature_info_t(int size) { allocateArray(size); } 
/*  577 */     public dc1394feature_info_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  582 */     public dc1394feature_info_t position(int position) { return (dc1394feature_info_t)super.position(position); }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     public native dc1394feature_info_t modes(dc1394.dc1394feature_modes_t paramdc1394feature_modes_t);
/*      */ 
/*      */     @ByRef
/*      */     public native dc1394.dc1394trigger_modes_t trigger_modes();
/*      */ 
/*      */     public native dc1394feature_info_t trigger_modes(dc1394.dc1394trigger_modes_t paramdc1394trigger_modes_t);
/*      */ 
...
/*      */ 
/*      */     public native dc1394feature_info_t trigger_sources(dc1394.dc1394trigger_sources_t paramdc1394trigger_sources_t);
/*      */ 
...
/*      */     {
/*  558 */       allocate(); } 
/*  559 */     public dc1394trigger_sources_t(int size) { allocateArray(size); } 
/*  560 */     public dc1394trigger_sources_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  565 */     public dc1394trigger_sources_t position(int position) { return (dc1394trigger_sources_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     public native int num();
/*      */ 
...
/*      */     {
/*  541 */       allocate(); } 
/*  542 */     public dc1394trigger_modes_t(int size) { allocateArray(size); } 
/*  543 */     public dc1394trigger_modes_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  548 */     public dc1394trigger_modes_t position(int position) { return (dc1394trigger_modes_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     public native int num();
/*      */ 
...
/*      */     {
/*  524 */       allocate(); } 
/*  525 */     public dc1394feature_modes_t(int size) { allocateArray(size); } 
/*  526 */     public dc1394feature_modes_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  531 */     public dc1394feature_modes_t position(int position) { return (dc1394feature_modes_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     public native int num();
/*      */ 
...
/*      */     {
/*  405 */       allocate(); } 
/*  406 */     public dc1394camera_list_t(int size) { allocateArray(size); } 
/*  407 */     public dc1394camera_list_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  412 */     public dc1394camera_list_t position(int position) { return (dc1394camera_list_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     public native int num();
/*      */ 
...
/*      */ 
/*      */     public native dc1394.dc1394camera_id_t ids();
/*      */ 
/*      */     public native dc1394camera_list_t ids(dc1394.dc1394camera_id_t paramdc1394camera_id_t);
/*      */ 
/*      */     static
/*      */     {
/*  404 */       Loader.load();
...
/*      */     {
/*  389 */       allocate(); } 
/*  390 */     public dc1394camera_id_t(int size) { allocateArray(size); } 
/*  391 */     public dc1394camera_id_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  396 */     public dc1394camera_id_t position(int position) { return (dc1394camera_id_t)super.position(position); }
/*      */ 
/*      */ 
...
/*      */     {
/*  338 */       allocate(); } 
/*  339 */     public dc1394camera_t(int size) { allocateArray(size); } 
/*  340 */     public dc1394camera_t(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*  345 */     public dc1394camera_t position(int position) { return (dc1394camera_t)super.position(position); }
/*      */ 
/*      */ 
/*      */     public native long guid();
/*      */ 
...
/*      */     {
/*  268 */       allocate(); } 
/*  269 */     public dc1394video_modes_t(int size) { allocateArray(size); } 
/*  270 */     public dc1394video_modes_t(Pointer p) { super(); }
/*      */ 
/*      */ 
/*      */     private native void allocate();
/*      */ 
...
/*      */     {
/*  255 */       allocate(); } 
/*  256 */     public dc1394color_codings_t(int size) { allocateArray(size); } 
/*  257 */     public dc1394color_codings_t(Pointer p) { super(); }
/*      */ 
/*      */ 
/*      */     private native void allocate();
/*      */ 
...
/*      */   {
/*      */     public Log_handler(Pointer p)
/*      */     {
/*  157 */       super(); } 
/*  158 */     protected Log_handler() { allocate(); }
/*      */ 
/*      */ 
/*      */     private native void allocate();
/*      */ 
...
/*      */     {
/*   80 */       allocate(); } 
/*   81 */     public pollfd(int size) { allocateArray(size); } 
/*   82 */     public pollfd(Pointer p) { super(); } 
/*      */     private native void allocate();
/*      */ 
/*      */     private native void allocateArray(int paramInt);
/*      */ 
/*   87 */     public pollfd position(int position) { return (pollfd)super.position(position); }
/*      */ 
/*      */ 
 ...
 * Qualified Name:     com.googlecode.javacv.cpp.dc1394
